...
const quickLinks = [
  { title: "Pay Online", description: "Make a secure payment for your imaging services. 3% convenience fee applies.", href: "#", icon: <path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z" /> },
  { title: "RX Upload", description: "Upload your prescription securely for faster appointment processing.", href: "#", icon: <path d="M9 16h6v-6h4l-7-7-7 7h4zm-4 2h14v2H5z" /> },
  { title: "Request CD/Films", description: "Request copies of your diagnostic images on CD or film.", href: "#", icon: <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 14.5c-2.49 0-4.5-2.01-4.5-4.5S9.51 7.5 12 7.5s4.5 2.01 4.5 4.5-2.01 4.5-4.5 4.5zm0-5.5c-.55 0-1 .45-1 1s.45 1 1 1 1-.45 1-1-.45-1-1-1z" /> },
  { title: "Patient Survey", description: "Help us improve by sharing your experience at our facility.", href: "#", icon: <path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z" /> },
];
